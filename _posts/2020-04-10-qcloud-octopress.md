...
description: 前几天腾讯云推出了静态网站托管服务，受邀体验一下将自己的博客迁移部署上去，顺便总结记录下，迁移结束，做个总结。
---
...
1. 创建腾讯云云开发环境
	...
	<img src="./../public/images/qcloud_oct_evn.png" width="70%" />
...
<img src="./../public/images/qcloud_oct_settings.png" width="70%" />
