...
目前已经制作了专门的镜像，对于新设备，完成分区以后，在已经完成大小写敏感分区的工作环境，可以使用[https://github.com/bihe0832/Settings-Tools/tools/mac_init.sh](https://github.com/bihe0832/Settings-Tools/tools/mac_init.sh) 完成各项配置。
